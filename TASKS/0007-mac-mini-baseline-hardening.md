...
> **Owner:** AI (`doc@appyhourlabs.com`) with human review (`matt@appyhourlabs.com`)  
> **Priority:** P2  
...
1. `doc@appyhourlabs.com` drafts episode using [`DOCS/SHOW/episodes/_TEMPLATE.md`](../DOCS/SHOW/episodes/_TEMPLATE.md) as the structural guide
...
5. Submit draft to `matt@appyhourlabs.com` for review via PR
6. `matt@appyhourlabs.com` approves and merges
...
- **Drafting:** AI (`doc@appyhourlabs.com`)
- **Gates:** AI QA agent
- **Final approval:** Human (`matt@appyhourlabs.com`)
...
- [ ] `matt@appyhourlabs.com` approved and merged the PR
